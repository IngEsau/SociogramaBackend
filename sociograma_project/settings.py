...
if not SECRET_KEY:
    raise ValueError("La variable SECRET_KEY debe estar definida en el archivo .env")
...
WSGI_APPLICATION = 'sociograma_project.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'sociograma_utp'),
...
# Agregar BrowsableAPIRenderer Y SessionAuthentication solo en desarrollo
if DEBUG:
...
# Solo en desarrollo permitir todos los orígenes
if DEBUG:
